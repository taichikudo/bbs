...
class MusicFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stars' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'stars' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-05-20 07:44:56'
            ],
        ];
        parent::init();
    }
